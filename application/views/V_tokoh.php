        ...
        <div class="col-sm">
            ...
            foreach($tokoh as $obj1){
                ...
                <div class="card bg-white p-4 rounded-lg shadow">
                    ...
                    <!-- Img top card -->
                    <img src="<?php echo base_url(); ?>a/foto_artikel/<?php echo $obj1->foto_artikel; ?>" style="width: 800px; height: 350px; padding: 0px 20px 0px 20px" class="img-fluid card-img-top" alt="...">
