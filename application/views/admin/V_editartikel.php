        ...
        <section class="content">
          <div class="col-md-6">
            <div class="box box-info">
              ...
              <form class="form-horizontal" method="POST" action="<?php echo base_url(); ?>Dashboard/update_artikel">
                <div class="box-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group col-sm-8">        
                      <input name="judul" type="text" class="form-control" placeholder="Judul Artikel" value="<?php echo $judul; ?>">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group col-sm-8">        
                      <textarea name="isi" type="text" class="form-control" placeholder="Isi Artikel"><?php echo $isi; ?></textarea>
                    </div>
                  </div>
