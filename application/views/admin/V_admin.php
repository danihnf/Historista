      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          <div class="row">
            ...
            <div class="col-lg-3 col-xs-6" style="margin-left: 25%;">
              <div class="small-box bg-blue">
                ...
                <a href="<?php echo base_url(); ?>Dashboard/akun" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div>
            ...
            <div class="col-lg-3 col-xs-6">
              <div class="small-box bg-green">
                ...
                <a href="<?php echo base_url(); ?>Dashboard/artikel" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div>
