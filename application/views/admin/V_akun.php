        ...
        <section class="content">
          <div class="col-md-6">
            <div class="box box-info">
              ...
              <form class="form-horizontal" method="POST" action="<?php echo base_url(); ?>Dashboard/inputuser">
                <div class="box-body">
                  ...
                  <table class="table table-hover">
                    <thead>
                      ...
                      <tr>
                        ...
                        <td>
                          <a href="<?php echo base_url(); ?>Dashboard/edit_admin/<?php echo $obj1->id; ?>"><button type="button" class="btn btn-warning glyphicon glyphicon-edit"></button> </a>

                          <a href="javascript:if(confirm('Anda yakin ingin menghapus data?')){document.location='<?php echo base_url(); ?>Dashboard/hapus_admin/<?php echo $obj1->id; ?>';}"><button type="button" class="btn btn-danger glyphicon glyphicon-trash"></button> </a>
                        </td>
                      </tr>
                    <?php } ?>
                    </thead>
