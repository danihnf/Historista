    ...
    <div class="row">
        ...
        <div class="col-sm">
            ...
            foreach($artikel as $obj1){
                ?>
                <div class="card bg-white p-4 rounded-lg shadow mb-3">
                    <!-- Profile Ava Card -->
                    ...
                    <!-- Img top card -->
                    <img src="<?php echo base_url(); ?>/foto_artikel/<?php echo $obj1->foto_artikel ?>" style="" class="img-fluid card-img-top" alt="...">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm">
                            <?php 
                                $nilai1 = $obj1->bintang*2.5;
                                $nilai2 = $obj1->bintang2*3.5;
                                $nilai3 = $obj1->bintang3*4;
                        ...
                        <a href="<?php echo base_url(); ?>Content/detail/<?php echo $obj1->id; ?>"><h5 class="card-title" style="font-size:16px;"><?php echo $obj1->judul; ?></h5></a> <!-- link to url post -->
                        <p class="card-text" style="font-size: 14px"><?php $isi = $obj1->isi; 
                        echo word_limiter($isi, 60);
                        ?></p>
                        <div class="row">
                            <div class="col-sm">
                                <a href="<?php echo base_url(); ?>Content/detail/<?php echo $obj1->id; ?>/<?php $slug = $obj1->judul;
                                        $string = preg_replace('/[^a-zA-Z0-9 &%|{.}=,?!*()"-_+$@;<>]/', '', $slug);
                                        $trim = trim($string);
                                ...
                                ?>" class="btn btn-outline-main" style="font-size: 13px">Lihat Selengkapnya</a> <!-- link to url post -->
                            </div>
                            <div class="col-sm">
                            </div>

                            <div class="col-sm text-right">
                                <a href="<?php echo base_url(); ?>Content/detail/<?php echo $obj1->id; ?>"><?php echo $obj1->jumlah_komentar; ?> Komentar</a>
                            </div>
                        </div>
                    </div>
                    <!-- end content body -->
