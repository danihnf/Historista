                        ...
                        <div class="card bg-white p-4 rounded-lg shadow">
                            ...
                            <div class="text-center" style="padding: 10px 20px">
                                ...
                                <div class="profile mt-3">
                                    <a href=""><h6 style="font-size: 16px"><?php echo $nama; ?></h6></a>
                                </div>
                            </div>
                            <hr />
                            ...
                            <!-- Content Card -->
                            <div class="card-body">
                                <form method="post" action="<?php echo base_url(); ?>Content/tulis_artikel" enctype="multipart/form-data">
                                    <input type="hidden" name="id" value="<?php echo $id; ?>" class="form-control">
                                    <input type="hidden" name="id_akun" value="<?php echo $id; ?>" class="form-control">
                                    <input type="hidden" name="penulis" value="<?php echo $this->session->userdata("email"); ?>" class="form-control">
                                    <input type="hidden" name="tgl_buat" value="<?php echo date('Y-m-d h:i:s'); ?>" class="form-control">

                                    <div class="form-group">
                                    <label for="formGroupExampleInput">Upload Gambar</label><br />
                                        <label for="inputFile"><h6 style="font-size: 13px; color: skyblue">Click to upload</h6></label>
                            <input type='file' class="" name="foto_artikel" id="inputFile" style="display:none; color: transparent; border-radius: 5px"/>
                                        <div class="jumbotron" id="container-img">
                                            <img id="img_upload_preview" class="img-fluid" src="" alt="" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="judul" type="text" class="form-control" id="formGroupExampleInput" placeholder="Masukan Judul">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="isi" style="height:400px" onchange=""></textarea>
                                    </div>

                                    <button type="submit" class="btn btn-outline-main">Posting</button>
                                </form>
